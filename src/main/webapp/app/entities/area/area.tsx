...
export class Area extends React.Component<IAreaProps> {
  ...
  render() {
    const { areaList, match } = this.props;
    return (
      <div>
        <h2 id="area-heading">
          <Translate contentKey="abstraktApp.area.home.title">Areas</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="abstraktApp.area.home.createLabel">Create new Area</Translate>
          </Link>
        </h2>
