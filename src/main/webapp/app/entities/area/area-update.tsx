...
export interface IAreaUpdateProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="abstraktApp.area.home.createOrEditLabel">
              <Translate contentKey="abstraktApp.area.home.createOrEditLabel">Create or edit a Area</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
