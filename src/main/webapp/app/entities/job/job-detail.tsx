...
export interface IJobDetailProps extends StateProps, DispatchProps, RouteComponentProps<{ id: any }> {}
  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="abstraktApp.job.detail.title">Job</Translate> [<b>{jobEntity.id}</b>]
          </h2>
