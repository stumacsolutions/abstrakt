...
export interface ICustomerDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: any }> {}
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody>
          <Translate contentKey="abstraktApp.customer.delete.question" interpolate={{ id: customerEntity.id }}>
