...
import uk.co.abstrakt.config.Constants;
import uk.co.abstrakt.AbstraktApp;
import uk.co.abstrakt.domain.Authority;
import uk.co.abstrakt.domain.PersistentToken;
import uk.co.abstrakt.domain.User;
import uk.co.abstrakt.repository.AuthorityRepository;
import uk.co.abstrakt.repository.PersistentTokenRepository;
import uk.co.abstrakt.repository.UserRepository;
import uk.co.abstrakt.security.AuthoritiesConstants;
import uk.co.abstrakt.service.MailService;
import uk.co.abstrakt.service.dto.UserDTO;
import uk.co.abstrakt.service.dto.PasswordChangeDTO;
import uk.co.abstrakt.web.rest.errors.ExceptionTranslator;
import uk.co.abstrakt.web.rest.vm.KeyAndPasswordVM;
import uk.co.abstrakt.web.rest.vm.ManagedUserVM;
import uk.co.abstrakt.service.UserService;
